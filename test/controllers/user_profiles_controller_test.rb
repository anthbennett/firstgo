...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { initials: @user_profile.initials, name: @user_profile.name, profile_pic: @user_profile.profile_pic, user_id: @user_profile.user_id }
    end
  ...
  test "should update user_profile" do
    patch :update, id: @user_profile, user_profile: { initials: @user_profile.initials, name: @user_profile.name, profile_pic: @user_profile.profile_pic, user_id: @user_profile.user_id }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
