...
class WorksheetsControllerTest < ActionController::TestCase
  ...
  test "should create worksheet" do
    assert_difference('Worksheet.count') do
      post :create, worksheet: { account_fees: @worksheet.account_fees, interest: @worksheet.interest, rent: @worksheet.rent }
    end
  ...
  test "should update worksheet" do
    patch :update, id: @worksheet, worksheet: { account_fees: @worksheet.account_fees, interest: @worksheet.interest, rent: @worksheet.rent }
    assert_redirected_to worksheet_path(assigns(:worksheet))
  end
